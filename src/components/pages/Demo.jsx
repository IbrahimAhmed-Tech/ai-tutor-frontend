...
export default function Demo() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-800 to-gray-950 flex flex-col items-center justify-center px-4 py-12">
            <h1 className="text-3xl sm:text-4xl font-bold text-gray-200 mb-4 font-robotoCondensed text-center">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-12 max-w-5xl w-full">
                <div className="border border-gray-700 rounded-2xl p-6 text-center bg-gray-800 shadow-xl hover:shadow-2xl transition-all duration-300">
                    <h3 className="font-semibold text-gray-100 mb-2 font-robotoCondensed">Real-Time Speech to Text</h3>
                ...
                <div className="border border-gray-700 rounded-2xl p-6 text-center bg-gray-800 shadow-xl hover:shadow-2xl transition-all duration-300">
                    <h3 className="font-semibold text-gray-100 mb-2 font-robotoCondensed">AI-Powered Replies</h3>
                    <p className="text-gray-300 text-sm font-poppins">
                ...
                <div className="border border-gray-700 rounded-2xl p-6 text-center bg-gray-800 shadow-xl hover:shadow-2xl transition-all duration-300">
                    <h3 className="font-semibold text-gray-100 mb-2 font-robotoCondensed">Speech + Avatar + Captions</h3>
                    <p className="text-gray-300 text-sm font-poppins">
            ...
            <Link
                to="/home"
                className="group relative w-ful flex justify-center items-center gap-2 py-3 px-4 font-poppins border border-transparent text-sm font-medium rounded-lg text-white bg-gray-700 hover:bg-gray-800 focus:outline-none focus:ring-1 focus:ring-offset-2 focus:ring-gray-500 transition-all duration-200 transform hover:scale-[1.02] disabled:opacity-50 disabled:cursor-not-allowed"
            >
                Start Your Journey
            </Link>
        </div>
